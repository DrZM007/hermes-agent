...
| RC | Recoverability Requirements | RecoverabilityRequirements.md |
...
*Note:* Architecture documents use their own decision/element identifiers (e.g., SA, DA, SEC, AI-ARCH, DB, DT, TM, MA) defined within `03-Architecture/`; those are element IDs, not requirement IDs, and are outside this table's scope.
